...
class Resimler {
  ...
  factory Resimler.fromMap(Map<String, dynamic> json) => Resimler(
        ...
        resimAltBaslik4: json["resimAltBaslik4"],
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "resimAltBaslik4": resimAltBaslik4,
      };
}
